...
# Canonical public entry point. Conversation navigation, constraint recall,
# continuation, identity and correction semantics now live in CognitivePipeline.run.
